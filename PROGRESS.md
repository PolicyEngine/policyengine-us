...
- [x] Step 2b: #9463 applied (`a6f1e8da14`) — isolation mechanism, county FIPS, docs, 16 regression
      tests, pinned_tbs.py cache key; dropped its PROGRESS.md

## Next
- [ ] Step 2c: #9448 reduced
- [ ] Step 2d: #9464 reduced
- [ ] Step 3: EXPANDED-REVIEW R1/R2 fixes; R8 FERA note in CPUC parameter
