...
class CPS(PublicDataset):
    ...
    def generate(self, year: int):
        ...
        self.add_ID_variables(
            cps, person, tax_unit, family, spm_unit, household
        )
        self.add_personal_variables(cps, person)
        self.add_personal_income_variables(cps, person)
        self.add_SPM_variables(cps, spm_unit)
