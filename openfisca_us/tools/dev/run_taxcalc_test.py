...
parser = ArgumentParser(description="Utility to run taxcalc on a single tax unit")
...
process = subprocess.Popen("tc taxcalc_output/input.csv 2020 --dump --outdir taxcalc_output", shell=True, stdout=subprocess.PIPE)
process.wait()
result = pd.read_csv(output_dir / "input-20-#-#-#.csv")
output = {}
