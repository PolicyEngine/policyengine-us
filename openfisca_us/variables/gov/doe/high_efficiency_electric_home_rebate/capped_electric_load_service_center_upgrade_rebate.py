...
class capped_electric_heat_pump_clothes_dryer_rebate(Variable):
    ...
    def formula(household, period, parameters):
        ...
        expenditures = household("electric_heat_pump_clothes_dryer_expenditures", period)
        cap = parameters(period).gov.doe.high_efficiency_electric_home_rebate.cap.electric_heat_pump_clothes_dryer
