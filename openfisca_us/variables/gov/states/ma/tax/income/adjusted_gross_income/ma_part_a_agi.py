...
class ma_part_a_agi(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        interest_dividends_deduction_cap = tax.capital_gains.deductible_against_interest_dividends
        ...
        remaining_long_term_loss = long_term_capital_loss - long_term_loss_against_short_term_gain
        remaining_interest_dividends = interest_and_dividends - short_term_loss_against_interest_dividends
        remaining_interest_deduction_cap = interest_dividends_deduction_cap - short_term_loss_against_interest_dividends
        ...
        long_term_gains_deduction = tax.capital_gains.long_term_deduction * long_term_capital_gains
