...
class mo_taxable_income(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        threshold = parameters(period).gov.states.mo.tax.income.itemization_threshold[filing_status]
        ...
        if total_itemized_federal_deductions > 0:
            ...
            if state_and_local_sales_or_income_tax > threshold:
                ...
                base_amount = parameters(period).gov.states.mo.tax.income.max_salt[filing_status]
                ...
                return tax_unit("adjusted_gross_income", period) - (items - net_state_income_taxes)
            else:
                return tax_unit("adjusted_gross_income", period) - (items - net_state_income_taxes)
