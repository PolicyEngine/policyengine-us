...
class ut_taxpayer_credit_maximum(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        personal_exemption = count_dependents * ut_taxpayer_credit.personal_exemption
        ...
        deductions_if_itemizing = [
            deduction for deduction in deductions_if_itemizing
            if deduction != "salt_deduction"
        ]
        us_itemized_deductions_less_salt = add(tax_unit, period, deductions_if_itemizing)

        total_deductions = personal_exemption + where(
            itemizes, 
            us_itemized_deductions_less_salt, 
