...
class qbid_limit(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        qualified_property = add(tax_unit, period, ["unadjusted_basis_qualified_property"])
        ...
        reduction = percent_through_phaseout * max_(0, income_based_deduction - w2_and_property_based_deduction)
