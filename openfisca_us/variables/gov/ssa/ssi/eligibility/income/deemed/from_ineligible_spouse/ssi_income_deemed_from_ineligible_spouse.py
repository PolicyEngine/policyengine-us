...
class ssi_income_deemed_from_ineligible_spouse(Variable):
    ...
    def formula(person, period, parameters):
        ...
        spousal_earned_income = person("ssi_earned_income_deemed_from_ineligible_spouse", period)
        spousal_unearned_income = person("ssi_unearned_income_deemed_from_ineligible_spouse", period)
        ...
        person_rate = person("is_ssi_ineligible_child", period) * (ssi.couple - ssi.individual) * MONTHS_IN_YEAR
