...
class ny_nyc_income_tax_before_credits(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        is_in_nyc = (county == counties.NEW_YORK_COUNTY_NY) | (county == counties.KINGS_COUNTY_NY) | (county == counties.QUEENS_COUNTY_NY) | (county == counties.BRONX_COUNTY_NY) | (county == counties.RICHMOND_COUNTY_NY) 
