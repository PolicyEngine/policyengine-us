...
class taxable_ss(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        modified_agi_plus_half_ss = tax_unit("ymod", period) # Defined in 26 U.S.C § 86(b)(2)
        ...
        excess_over_adjusted_base = max_(0, modified_agi_plus_half_ss - adjusted_base_amount)
        ...
        amount_if_over_second_threshold = min_(
            ...
            + min_(amount_if_under_second_threshold, ss.rate.lower * (adjusted_base_amount - base_amount)),
