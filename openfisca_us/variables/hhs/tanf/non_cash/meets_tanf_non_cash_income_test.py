...
class meets_tanf_non_cash_income_test(Variable):
    ...
    documentation = "Income eligibility (as a percent of the poverty line) for TANF non-cash benefit for SNAP BBCE"
    ...
    def formula(spm_unit, period, parameters):
        ...
        income_fpg = spm_unit("snap_net_income_fpg_ratio", period)
