...
def create_tax_employer_payroll_tax_reform(parameters, period, bypass: bool = False):
...
tax_employer_payroll_tax_reform_object = create_tax_employer_payroll_tax_reform(
