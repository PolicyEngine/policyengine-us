...
def tax_employer_social_security_tax_reform() -> Reform:
    """
...
def create_tax_employer_social_security_tax_reform(
    ...
    if bypass is True:
        return tax_employer_social_security_tax_reform()

    # 2. If boolean in in_effect.yaml is set to true
    parameter = parameters.gov.contrib.crfb.tax_employer_social_security_tax
...
tax_employer_social_security_tax_reform_object = (
    create_tax_employer_social_security_tax_reform(None, None, bypass=True)
)
