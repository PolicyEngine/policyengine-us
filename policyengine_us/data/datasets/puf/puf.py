...
class PUF(Dataset):
    ...
    def generate(self, puf_file_path: str = None, puf_demographics_path: str = None):
        ...
        puf, demographics = load_puf(puf_file_path=puf_file_path, puf_demographics_path = None)
