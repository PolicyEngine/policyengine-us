...
class heating_expenses(Variable):
    ...
    reference = (
        ...
        # Line 13: November 1 - October 31 billing window and bulk-fuel
        # receipts added to the total heating cost (shared housing on
        # file page 5).
        "https://www.michigan.gov/taxes/-/media/Project/Websites/taxes/Forms/IIT/TY2025/MI-1040CR-7-Book.pdf#page=6",
    )
