...
class has_heating_cooling_expense(Variable):
    ...
    documentation = (
        "Whether the household incurs heating or cooling costs separately from its "
        "rent or mortgage, which qualifies it for the SNAP heating and cooling "
        "standard utility allowance. Heating is the has_heating_expense fact and "
        "cooling is the has_cooling_expense fact. Households whose heating_type is "
        "UNSPECIFIED keep the pre-canonical signal, a positive "
