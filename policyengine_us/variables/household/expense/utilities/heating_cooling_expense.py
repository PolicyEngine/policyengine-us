...
class heating_cooling_expense(Variable):
    ...
    documentation = (
        ...
        "LIHEAP adapters for households whose heating_type is UNSPECIFIED. The SNAP "
        "utility allowance determination reads it only for households whose "
        "heating_type is UNSPECIFIED."
    )
