...
class me_tanf_standard_of_need(Variable):
    value_type = float
    entity = SPMUnit
    label = "Maine TANF standard of need"
    unit = USD
    ...
    def formula(spm_unit, period, parameters):
        ...
        # Different standards for Adult Included vs Child Only cases
        ...
        adult_included_base = p.standard_of_need.adult_included[capped_size]
        child_only_base = p.standard_of_need.child_only[capped_size]
        base_amount = where(
