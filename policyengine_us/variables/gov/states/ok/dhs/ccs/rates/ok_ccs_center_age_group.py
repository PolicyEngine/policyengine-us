...
class OKCCSCenterAgeGroup(Enum):
    MONTHS_0_TO_12 = "0 to 12 months"
    MONTHS_13_TO_24 = "13 to 24 months"
    MONTHS_25_TO_48 = "25 to 48 months"
    MONTHS_49_TO_72 = "49 to 72 months"
    MONTHS_73_PLUS = "73 months to 13 years"


class ok_ccs_center_age_group(Variable):
    value_type = Enum
    entity = Person
    possible_values = OKCCSCenterAgeGroup
    default_value = OKCCSCenterAgeGroup.MONTHS_73_PLUS
    definition_period = MONTH
    label = "Oklahoma Child Care Subsidy child care center rate age group"
