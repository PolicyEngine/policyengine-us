...
class ok_ui(Variable):
    ...
    Not modeled: § 1-201(48) / § 1-217(B) alternative and extended base
    periods; § 2-104(B) max-WBA percentage derivation by fund condition
    (only the resulting maximum dollar amount is parameterized); § 2-106(2)
    statutory %-of-average-annual-wage benefit-year cap (OESC-published proxy
    used instead); § 1-217(B)(2) 15% wage/hour-loss unemployment prong;
    § 1-231 16-to-26-week claim-volume duration escalation above the 16-week
    floor; § 2-107 portion-of-a-week proration; § 2-108 approved training
    waiver; § 2-202 / § 2-205.1 able-available-seeking-work; § 2-206 one-week
    waiting period; § 2-208 alien-status rules; § 2-109 10x WBA
    requalification; § 1-202.1 / § 1-202.2 alternative and extended base
    periods; all § 2-404 through § 2-422 disqualifications.
    """
    ...
    documentation = (
        ...
        "§ 2-206 one-week waiting period; the § 1-202.1 / § 1-202.2 "
        "alternative and extended base periods; and the § 2-404 through "
