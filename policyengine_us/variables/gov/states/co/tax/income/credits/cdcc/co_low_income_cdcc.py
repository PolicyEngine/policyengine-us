...
class co_low_income_cdcc(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        if not p.unified:
            ...
            eligible_kid = age < p.child_age_threshold
            ...
            eligible_kid_ratio[mask] = (
                eligible_kids[mask] / total_eligibles[mask]
            )
            ...
            credit = p.rate * capped_kid_expenses  # Line 11
            cap = p.max_amount.calc(eligible_kids)  # Table A
