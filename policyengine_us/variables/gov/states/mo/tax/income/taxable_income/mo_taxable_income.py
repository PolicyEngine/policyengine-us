...
class mo_taxable_income(Variable):
    ...
    def formula(person, period, parameters):
        ...
        mo_pension_and_ss_or_ssd_deduction = tax_unit("mo_pension_and_ss_or_ssd_deduction", period)

        # NB: The federal income tax deduction applies regardless of itemization.
        all_deductions_tax_unit = (
            mo_itemized_or_standard + mo_federal_income_tax_deduction + mo_pension_and_ss_or_ssd_deduction
        )
