...
class mo_itemized_deductions(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        eligible_ss_or_ssd = tax_unit('mo_pension_and_ss_or_ssd_section_a', period)
        ...
        total_public_pensions = tax_unit('mo_pension_and_ss_or_ssd_section_b', period)

        # Section B, Private Pension Amounts
        total_private_pensions =  tax_unit('mo_pension_and_ss_or_ssd_section_c', period)
