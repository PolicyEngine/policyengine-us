...
class mo_pension_and_ss_or_ssd_deduction_section_b(Variable):
    ...
    def formula(person, period, parameters):
        ...
        agi_over_private_pension_allowance = max_(agi_in_excess_of_taxable_social_security - private_pension_allowance, 0)
        private_pension_amount = person("pension_income", period)
        max_private_pension_amount = p.mo_max_private_pension
        private_pension_value = min_(private_pension_amount, max_private_pension_amount)
        total_private_pensions =  max_(private_pension_value - agi_over_private_pension_allowance, 0)
