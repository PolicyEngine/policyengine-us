...
class ma_eaedc_net_income(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        earned_income = add(spm_unit, period, ["ma_eaedc_earned_income"])
        gross_earned_income = earned_income - p.deductions.work_related_expense 
        ...
        dependent_care_deduction_eligible = add()
        # age = age of dependent 
        net_earned_income = max_(
            earned_income_after_disregard - p.deductions.dependent_care_expense.calc(age), 0
        )
