...
class ma_connector_care_member_eligible(Variable):
    ...
    documentation = (
        ...
        "presence, non-incarceration, on-Marketplace enrollment, the "
        "married-filing-separately exclusion, the required-contribution income "
        "test, and the absence of affordable employer coverage or Medicare or "
        "MassHealth minimum essential coverage, all via the federal chain. "
