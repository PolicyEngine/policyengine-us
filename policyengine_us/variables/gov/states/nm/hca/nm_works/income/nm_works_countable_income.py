...
class nm_works_countable_income(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        countable_earned = spm_unit("nm_works_countable_earned_income", period)
        countable_unearned = spm_unit(
            "nm_works_countable_unearned_income", period
        )
        child_care_deduction = spm_unit(
            "nm_works_child_care_deduction", period
        )
