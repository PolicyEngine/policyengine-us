...
class al_tanf_financial_eligibility(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        care_and_child_care_expenses = add(spm_unit, period, ["childcare_expenses", "care_expenses"])
        total_disregard = (care_and_child_care_expenses * p.expense_disregard_rate)
