...
class al_tanf_applicable_income(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        work_expense_deduction = spm_unit("al_tanf_work_expense_deduction", period)
        # Get net self-employment income
        net_self_employment_income = spm_unit("al_tanf_self_employment_net_income", period)
        # Calculate earned income after deductions
        applicable_earned_income = max_(total_earned_income + net_self_employment_income - work_expense_deduction, 0)
