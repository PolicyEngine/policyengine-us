...
class al_ccsp_protective_services(Variable):
    ...
    def formula(spm_unit, period, parameters):
        # State Plan §2.2.2(f) checks four protective-services sub-populations:
        ...
        # (iii) Early Head Start Child Care Partnerships (EHS-CCP) — we
        #       don't track EHS-CCP enrollment at the moment
        # (iv) homelessness — modeled via is_homeless
        # The two unmodeled categories under-count protective-services
