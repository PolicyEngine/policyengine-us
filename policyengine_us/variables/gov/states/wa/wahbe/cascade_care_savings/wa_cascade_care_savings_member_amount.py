...
class wa_cascade_care_savings_member_amount(Variable):
    ...
    documentation = (
        ...
        "members without a federally recognized immigration status who are not "
        "eligible for Washington Apple Health Expansion receive the "
        "without-federal-subsidy amount ($250 PMPM for PY2026). Group 3 "
        "excludes Apple Health Expansion enrollees to avoid double counting "
        "with the Medicaid-cost proxy in healthcare_benefit_value, leaving the "
        "undocumented residual between 138% and 250% FPL. Group 2 (lawfully "
        "present but premium-tax-credit-ineligible) is not separately "
        "identifiable in the model and is documented away. The monthly amount "
        "is annualized by MONTHS_IN_YEAR, assuming full-year enrollment."
    )
    ...
    def formula(person, period, parameters):
        ...
        # Group 3: undocumented residents who are not eligible for Washington
        # Apple Health Expansion (the model's undocumented-adult Medicaid-cost
        # proxy), leaving the undocumented 138%-250% FPL residual.
