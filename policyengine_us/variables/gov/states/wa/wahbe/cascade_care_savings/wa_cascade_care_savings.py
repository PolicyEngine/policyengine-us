...
class wa_cascade_care_savings(Variable):
    ...
    documentation = (
        ...
        "Approximations: SLCSP (second-lowest-cost silver) proxies both the "
        "enrolled plan and the county lowest-cost Cascade Care Silver plan, so "
        "the two statutory caps collapse to a single expression; the Cascade "
