...
class wa_pfml_weekly_benefit_amount(Variable):
    ...
    documentation = (
        ...
        "RCW 50A.15.020(5), rounds down to the next lower dollar, and clips "
        "the result to the statutory minimum and maximum weekly benefit "
        "amounts. Despite the YEAR definition period, this variable "
        "represents a weekly dollar amount."
    )
    unit = USD
    ...
    def formula(person, period, parameters):
        ...
        raw_benefit = np.floor(lower_benefit + upper_benefit)
