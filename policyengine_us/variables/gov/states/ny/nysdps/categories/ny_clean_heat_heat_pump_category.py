...
class NyCleanHeatHeatPump(Enum):
    ...
    C2C = (
        "Multifamily Full Load ASHP Heating with Decommissioning"  # (2.1.1)(3.4.2.1-2)
    )
    ...
    C9 = (
        "Simultaneous Installation of Space Heating & Domestic Water Heating"  # (3.3.3)
    )
...
class ny_clean_heat_heat_pump_category(Variable):
    ...
    documentation = (
        "Heat pump technologies that qualify for Clean Heat program incentives."
    )
    reference = [
