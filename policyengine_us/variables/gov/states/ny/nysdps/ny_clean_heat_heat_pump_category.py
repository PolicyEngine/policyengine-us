...
class NyCleanHeatHeatPump(Enum):
    ...
    C2B = "ccASHP: Full Load Heating with decommissioning" # (2.1.1)(3.4.2.1-2) 
...
class ny_clean_heat_heat_pump_category(Variable):
    ...
    reference = ["https://cleanheat.ny.gov/assets/pdf/CHG&E%20NGrid%20NYSEG%20O&R%20and%20RG&E%20Program%20Manual_3.1.2024.pdf",
                  "https://cleanheat.ny.gov/assets/pdf/CECONY%20Clean%20Heat%20Program%20Manual%206%203%2024.pdf"] # (2.1)(3.3)
