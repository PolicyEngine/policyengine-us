...
class ny_ccap_age_eligible(Variable):
    ...
    documentation = (
        ...
        "The court-supervision route uses is_in_secondary_school to require "
        "secondary education or equivalent training for the under-19 extension."
    )
    reference = (
    ...
    def formula(person, period, parameters):
        ...
        secondary_student = student & person("is_in_secondary_school", period)
