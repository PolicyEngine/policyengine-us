...
class ny_tanf_supplemental_home_energy_allowance(Variable):
    value_type = float
    entity = SPMUnit
    label = "New York TANF supplemental home energy allowance"
    unit = USD
    ...
    def formula(spm_unit, period, parameters):
        ...
        return (
            p.supplemental_home_energy.main[capped_size]
            + p.supplemental_home_energy.additional * additional_size
        )
