...
class ny_solar_energy_systems_equipment_credit(Variable):
    ...
    def formula(tax_unit, parameters, period):
        qualified_solar_energy_systems_equipment_expenditures = tax_unit(
            "qualified_solar_energy_systems_equipment_expenditures", period
        )
        p = parameters(
            period
        ).gov.states.ny.tax.income.credit.solar_energy_systems_equipment
        solar_equipment_expenditures_fraction = (
            qualified_solar_energy_systems_equipment_expenditures * p.rate
        )
