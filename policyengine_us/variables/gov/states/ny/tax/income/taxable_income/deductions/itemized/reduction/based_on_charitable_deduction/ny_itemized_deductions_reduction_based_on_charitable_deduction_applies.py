...
class ny_itemized_deductions_reduction_based_on_charitable_deduction_applies(Variable):
    value_type = bool
    entity = TaxUnit
    ...
    def formula(tax_unit, period, parameters):
        p = parameters(period).gov.states.ny.tax.income.deductions.itemized.reduction
