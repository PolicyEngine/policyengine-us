...
class ar_income_tax_before_non_refundable_credits_unit(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        itax_indiv = add(tax_unit, period, ["ar_income_tax_before_non_refundable_credits_indiv"])
        itax_joint = add(tax_unit, period, ["ar_income_tax_before_non_refundable_credits_joint"]) 
