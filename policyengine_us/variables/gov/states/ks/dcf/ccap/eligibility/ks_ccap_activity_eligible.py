...
class ks_ccap_activity_eligible(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        # 20 hours per week. The post-secondary pathway is "Child Care for
        # Employed Persons Also Attending Approved Education/Training," so
        # education does not bypass the employment test - employed students
        # already qualify through the hours test. We don't model the federal
        # minimum-wage earnings floor, nor the other need pathways at the
        # moment: the unemployed food assistance work program participant and
        # the "children need child care to prevent abuse and/or neglect"
        # pathways (both exempt from the financial-need test under KEESM 7540),
        # nor teen-parent high school/GED education, crisis services, Early
        # Head Start partnership, or foster care.
        ...
        individually_eligible = hours_worked >= p.activity_hours
