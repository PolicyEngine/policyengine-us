...
class de_additional_standard_deduction_indv(Variable):
    value_type = float
    entity = Person
    label = "Delaware additional standard deduction when married couples are filing separately"
    unit = USD
    ...
    def formula(person, period, parameters):
        # Do we need to check whether the couples will take itemized deduction first?
        p = parameters(
            period
