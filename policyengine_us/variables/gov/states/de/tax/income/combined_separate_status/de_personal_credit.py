rom policyengine_us.model_api import *


class de_aged_personal_credit(Variable):
    value_type = float
    entity = TaxUnit
    label = "Delaware aged personal credit for combined separate filing status"
    unit = USD
    ...
    def formula(tax_unit, period, parameters):
        ...
        # head_amount on column B, and spouse amount on column A
