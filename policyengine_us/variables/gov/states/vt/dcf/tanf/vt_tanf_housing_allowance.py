...
class vt_tanf_housing_allowance(Variable):
    value_type = float
    entity = SPMUnit
    label = "Vermont TANF housing allowance"
    unit = USD
    ...
    def formula(spm_unit, period, parameters):
        ...
        p = parameters(period).gov.states.vt.dcf.tanf.income.housing.maximum
        ...
        annual_housing_cost = spm_unit("housing_cost", period.this_year)
        monthly_housing_cost = annual_housing_cost / MONTHS_IN_YEAR
        return min_(monthly_housing_cost, housing_max)
