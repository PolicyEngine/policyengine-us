...
class vt_tanf_countable_unearned_income(Variable):
    value_type = float
    entity = SPMUnit
    label = "Vermont TANF countable unearned income"
    unit = USD
    ...
    def formula(spm_unit, period, parameters):
        # Per 33 V.S.A. Section 1103(a)(4): $100/month child support disregard
        p = parameters(period).gov.states.vt.dcf.tanf.income.disregard
