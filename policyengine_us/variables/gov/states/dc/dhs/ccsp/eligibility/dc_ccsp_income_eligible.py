...
class dc_ccsp_income_eligible(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        new_applicants_income_limit = fpg * p.new_applicants_rate   # 300%FPG
        redetermination_income_limit = smi * p.redetermination_rate # 85% SMI
        income_limit = where(enrolled_in_ccsp, redetermination_income_limit, new_applicants_income_limit)
