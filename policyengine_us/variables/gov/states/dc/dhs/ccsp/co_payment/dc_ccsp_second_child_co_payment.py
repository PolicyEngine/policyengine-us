...
class dc_ccsp_second_child_co_payment(Variable):
    value_type = float
    entity = Person
    unit = USD
    label = (
        "DC Child Care Subsidy Program (CCSP) second child co-payment amount"
    )
    ...
    def formula(person, period, parameters):
        p = parameters(period).gov.states.dc.dhs.ccsp.co_payment.second_child
