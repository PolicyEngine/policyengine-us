...
class dc_liheap_payment(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        housing_type = spm_unit("housing_type", period)
        utility_type = spm_unit("dc_liheap_utility_type", period)
        ...
        electric_expense = add(
            spm_unit, period, ["pre_subsidy_electricity_expense"]
        )
        ...
        gas_expense = add(spm_unit, period, ["gas_expense"])
        ...
        oil_expense = add(spm_unit, period, ["oil_expense"])
