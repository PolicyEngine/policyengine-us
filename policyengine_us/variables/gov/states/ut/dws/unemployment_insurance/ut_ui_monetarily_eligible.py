...
class ut_ui_monetarily_eligible(Variable):
    ...
    # Not modeled: § 35A-4-403(1)(f)(ii) provides an alternative to the 1.5x
    # high-quarter-wage ratio test — wages in insured work for at least 20
    # weeks in the base period. That alternative sunset on or before Jan 1,
    # 2011, so only the § 35A-4-403(1)(f)(i) ratio test is modeled here.
    ...
    def formula(person, period, parameters):
        ...
        # R994-401-201: wages in at least two base-period quarters.
        meets_quarters_test = (
