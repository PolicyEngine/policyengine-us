...
class ut_federal_deductions_for_taxpayer_credit(Variable):
    ...
    def formula(tax_unit, period, parameters):
        # itemized deductions (exclude SALT)
        ...
        ite_deductions = add(tax_unit, period, deductions)

        # include capped real estate taxes in federal deductions
        ...
        return ite_deductions + capped_real_estate_tax
