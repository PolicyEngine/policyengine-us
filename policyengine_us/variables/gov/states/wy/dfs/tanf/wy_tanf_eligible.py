...
class wy_tanf_eligible(Variable):
    value_type = bool
    entity = SPMUnit
    label = "Wyoming TANF eligible"
    ...
    def formula(spm_unit, period, parameters):
        ...
        income_eligible = spm_unit("wy_tanf_income_eligible", period)
        resource_eligible = spm_unit("wy_tanf_resource_eligible", period)
