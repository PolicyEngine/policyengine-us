...
class wi_standard_deduction(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        deduction = parameters(period).gov.states.wi.tax.income.deduction
        max_amount = deduction.max[fstatus]
        ...
        phase_out_amount = select(
            ...
            [
                deduction.phase_out.single.calc(agi),
                deduction.phase_out.joint.calc(agi),
                deduction.phase_out.joint.calc(agi),
                deduction.phase_out.separate.calc(agi),
                deduction.phase_out.head_of_household.calc(agi),
            ],
        )
