...
class is_ca_state_medicaid_eligible(Variable):
    ...
    def formula(person, period, parameters):
        ...
        not_federally_eligible = ~person("is_medicaid_immigration_status_eligible", period)
        ...
        is_child_eligible = person("is_ca_state_medicaid_child_eligible", period)
        is_young_adult_eligible = person("is_ca_state_medicaid_young_adult_eligible", period)
        is_adult_eligible = person("is_ca_state_medicaid_adult_eligible", period)
        is_older_adult_eligible = person("is_ca_state_medicaid_older_adult_eligible", period)
        ...
        return is_ca & categorically_eligible & not_federally_eligible & age_eligible