...
class ca_foster_youth_tax_credit(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        base_credit = p.amount
        eligible_person = tax_unit ("ca_foster_youth_tax_credit_eligible_person",period)
        eitc_eligible = tax_unit("ca_eitc_eligible",period)
        total_base_credit = base_credit * eligible_person * eitc_eligible 
