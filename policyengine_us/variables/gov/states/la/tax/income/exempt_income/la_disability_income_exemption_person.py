...
class la_disability_income_exemption_person(Variable):
    ...
    def formula(person, period, parameters):
        p = parameters(period).gov.states.la.tax.income.exempt_income.disability
        ...
        total_disablity_exemption = capped_disability_benefits * is_head_or_spouse
        # People who reveive the blind exemption are not eligible for
        # the disability income exemption
        blind_exemption_received = person("la_receives_blind_exemption", period)
