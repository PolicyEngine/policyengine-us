...
class la_tanf_earned_income_deduction(Variable):
    value_type = float
    entity = Person
    label = "Louisiana TANF earned income deduction"
    unit = USD
    ...
    def formula(person, period, parameters):
        p = parameters(period).gov.states.la.dcfs.tanf.income.deductions
