...
class oh_educator_expense_deduction_person(Variable):
    ...
    # Replacing the federal educator_expense in oh/.../deductions.yaml with
    # this Ohio-specific stub means filers without explicit input receive 0
    # for Ohio purposes; downstream microdata should populate it.
    reference = (
