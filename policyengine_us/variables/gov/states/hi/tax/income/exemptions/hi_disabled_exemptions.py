...
class hi_disabled_exemptions(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        conditional_dependent_amount = where(any_disabled_head_or_spouse, 0, dependent_amount)
        ...
        conditional_head_or_spouse_amount = max_(disabled_exemption, head_or_spouse_amount)
        total_conditional_head_or_spouse_amount = tax_unit.sum(conditional_head_or_spouse_amount)
        return conditional_dependent_amount + total_conditional_head_or_spouse_amount
