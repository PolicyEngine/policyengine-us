...
class tx_liheap_income(Variable):
    ...
    documentation = "Total monthly countable household income for Texas LIHEAP eligibility determination"
    ...
    def formula(spm_unit, period, parameters):
        ...
        self_employment_income = person(
            "self_employment_income", period.this_year
        )
        ...
        unemployment_compensation = person(
            "unemployment_compensation", period.this_year
        )
        ...
        taxable_pension_income = person(
            "taxable_pension_income", period.this_year
        )
