...
class ct_pension_annuity_subtraction(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        rate = parameters(period).gov.states.ct.tax.income.subtractions.pensions_or_annuity.rate
...
# head = person("is_tax_unit_head", period) - bool
        
# spouse = person("is_tax_unit_spouse", period) - bool

# head_or_spouse = head | spouse  - bool

# pension = person("taxable_pension_income", period)

# eligibl_pension = pension * head_or_spouse

# total_pension = tax_unit.sum(eligibl_pension)