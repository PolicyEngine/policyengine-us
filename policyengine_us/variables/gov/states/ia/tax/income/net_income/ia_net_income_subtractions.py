...
class ia_net_income_subtractions(Variable):
    value_type = float
    entity = TaxUnit
    label = "Iowa net income subtractions relative to federal AGI"
    unit = USD
    ...
    adds = "gov.states.ia.tax.income.net_income.subtractions"
