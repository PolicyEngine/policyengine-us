...
class mi_fip_countable_earned_income_initial(Variable):
    value_type = float
    entity = SPMUnit
    label = "Michigan FIP countable earned income for initial eligibility"
    unit = USD
    ...
    adds = ["mi_fip_earned_income_after_deductions_initial_person"]
