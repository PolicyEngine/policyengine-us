...
class mi_standard_deduction_tier_two(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        capped_pension_income = (
            max_(uncapped_pension_income, p.non_qualifying) * ~age_threshold
        )
        ...
        return where(
            sd2_age_eligibility,
            capped_pension_income + tier_two_standard_deduction,
            0,
        )
