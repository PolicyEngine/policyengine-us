...
class heating_credit(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        return p.home_heating_credit_rate * (where(rent_include_heating_cost==True,(p.reduced_standard_allowance_rate * mi_reduced_standard_allowance),max(mi_reduced_standard_allowance,mi_alternate_household_credit)))
