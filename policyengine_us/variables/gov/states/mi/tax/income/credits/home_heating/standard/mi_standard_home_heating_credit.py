...
class mi_standard_home_heating_credit(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        # TY2025 MI-1040CR-7 line 36 (Michigan renumbers the form between
        # years): Table A standard allowance for the exemptions claimed.
        ...
        # TY2025 line 39: heating costs included in rent halve the standard
        # credit (MCL 206.527a(1)(c)(i)).
