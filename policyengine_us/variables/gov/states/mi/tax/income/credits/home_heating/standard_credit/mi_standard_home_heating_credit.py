...
class mi_standard_home_heating_credit(Variable):
    ...
    def formula(tax_unit, period, parameters):
        ...
        # Line 38
        base_amount = p.base.calc(exemption_count)
        ...
        reduced_household_resources = household_resources * p.household_resources.rate
        # Line 40
        ...
        return where(utilities_included_in_rent, reduced_base * p.included_heating_cost_rate, reduced_base)
