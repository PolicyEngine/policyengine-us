...
class md_tanf_net_countable_income(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        countinuous_deductions = spm_unit("md_tanf_continuous_earnings_deductions", period)
        ...
        return gross_earned_income + gross_unearned_income - countinuous_deductions - alimony_deduction - child_support_deduction - childcare_deduction
