...
from policyengine_us.variables.gov.states.md.tanf.md_tanf_count_children import md_tanf_count_children
...
class md_tanf_childcare_deduction(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        childcare_deduction = 200 * (workhours >= 100) * md_tanf_count_children + 100 * (workhours < 100) * md_tanf_count_children
