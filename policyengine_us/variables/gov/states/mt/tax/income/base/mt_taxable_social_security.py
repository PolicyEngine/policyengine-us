...
class mt_taxable_social_security(Variable):
    ...
    def formula(person, period, parameters):
        ...
        tax_exempt_interest_income = person("tax_exempt_interest_income", period)
        ...
        ald_less_student_loan = person("mt_applicable_ald_deductions", period) - person(
            "student_loan_interest_ald", period
        )
