...
class mt_tanf_eligible_child(Variable):
    ...
    reference = (
        "https://www.law.cornell.edu/regulations/montana/Mont-Admin-r-37.78.103#35"
    )
    ...
    def formula(person, period, parameters):
        ...
        secondary_school_student = person("is_in_secondary_school", period.this_year)
        age_limit = where(secondary_school_student, p.student_dependent, p.minor_child)
