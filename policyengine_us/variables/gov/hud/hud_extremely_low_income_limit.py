...
class hud_extremely_low_income_limit(Variable):
    value_type = float
    entity = SPMUnit
    label = "HUD extremely low income limit"
    unit = USD
    documentation = "HUD Section 8 extremely low income limit for the SPM unit's county and family size"
