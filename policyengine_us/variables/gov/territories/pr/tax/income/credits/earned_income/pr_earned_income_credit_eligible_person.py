...
class pr_earned_income_credit_eligible_person(Variable):
    ...
    def formula(person, period, parameters):
        ...
        unearned_income = person("pr_earned_income_credit_unearned_income", period)
        unearned_income_amount_under_limit = unearned_income <= p.unearned_income.limit
        ...
        eligible = (
            head_or_spouse & unearned_income_amount_under_limit & age_within_range
        )
