...
class snap_limited_utility_allowance(Variable):
    ...
    def formula(spm_unit, period, parameters):
        ...
        lua_household_size_dependent = spm_unit("snap_limited_utility_allowance_by_household_size", period)
        ...
        lua = where(lua_household_size_dependent,
                    p.by_household_size.amount[region][capped_size], lua)
