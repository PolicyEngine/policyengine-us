...
class medicaid_community_engagement_pass_through_eligible(Variable):
    ...
    documentation = "Under 42 CFR 435.554(c)(7) (CMS-2454-IFC), the SNAP exclusion from the Medicaid community engagement requirement is a status test: the individual is a member of a household receiving SNAP and is not exempt from (i.e., is subject to) a SNAP work requirement. Unlike the TANF exclusion, states do not confirm actual compliance with SNAP work requirements. The model tests subject-to status with the general work requirement age brackets and non-age registration exemptions; the 7 CFR 273.7(b)(1)(vii) exemption for people working 30 or more hours weekly is not netted out, and post-HR1 adults aged 60-64 who are subject only to the ABAWD requirement are not separately captured."
    reference = (
