...
class medicaid_ltss_qit_adjusted_income(Variable):
    ...
    documentation = (
        ...
        "treatment and applicant/spouse ownership allocation. The model does "
        "not validate trust legality, irrevocability, funding, payback terms, "
        "or which income was validly deposited. The user must perform those "
        "determinations before supplying this value."
    )
    reference = (
