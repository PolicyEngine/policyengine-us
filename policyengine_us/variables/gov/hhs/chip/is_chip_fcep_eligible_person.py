...
class is_chip_fcep_eligible_person(Variable):
    ...
    documentation = (
        "Determines if a pregnant person is eligible for the Children's Health "
        "Insurance Program through the Family Coverage Extension Program"
    )
    ...
    def formula(person, period, parameters):
        ...
        alabama_fcep_county = np.isin(county_str, p.al_counties)
