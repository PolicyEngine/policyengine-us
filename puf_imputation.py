...
cps_data["XOODEP"] = np.minimum(cps_data.tax_unit_count_dependents - cps_data.tax_unit_children, EXEMPTION_CAP)
...
with col1:
    ...
    mars = st.selectbox("MARS", ["SINGLE", "JOINT", "WIDOW", "SEPARATE", "HEAD_OF_HOUSEHOLD"])
